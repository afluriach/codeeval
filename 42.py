...
#the mapping that describes x mod 7 -> (x*10) mod 7
#mod7_mult10 = {
#    0 : 0,
#    1 : 3,
#    2 : 6,
...
#multiplying by 10 will yield 0mod2, 0mod5, unchanged mod3    
#and use the mapping above for mod7
#def mult10(mod_tuple):
#    return(0,mod_tuple[1],0,mod7_mult10[mod_tuple[3]])
#end
